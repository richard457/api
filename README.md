# YegoBoxApi OpenAPI Specification
[![Build Status](https://travis-ci.org/richard457/api.svg?branch=master)](https://travis-ci.org/richard457/api)
...
6. If you did everything correct, https://richard457.github.io/api/ will lead to your new docs
...
- Documentation(ReDoc): https://richard457.github.io/api/
- SwaggerUI: https://richard457.github.io/api/swagger-ui/
- Look full spec:
    + JSON https://richard457.github.io/api/swagger.json
    + YAML https://richard457.github.io/api/swagger.yaml
- Preview spec version for branch `[branch]`: https://richard457.github.io/api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://richard457.github.io/api/ with url from the message: `Server started <url>`
