# YeGoBox Api OpenAPI Specification
[![Build Status](https://travis-ci.com/richard457/api.svg?branch=master)](https://travis-ci.com/richard457/api)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://richard457.github.io/api/)
- [SwaggerUI](https://richard457.github.io/api/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://richard457.github.io/api/openapi.json) [YAML](https://richard457.github.io/api/openapi.yaml)
